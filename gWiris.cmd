...
set "crashed=%rootsq%\%id%-crash.gWiris.txt"
title gWiris %ver% - %PROCESSOR_IDENTIFIER%
echo [%date% , %time%][b%ver%] Logged in. (%id%) >>%rootsq%\sessions.inf
...
rem launcher.ini
if EXIST launcher.ini (attrib -h launcher.ini & del /f /q launcher.ini)
...
echo. >>launcher.ini 
echo automated gWiris ini file >>launcher.ini
...
rem Key cracking
if %clip%==1 goto xp
echo 7QG8G-J6Q7Q-PENS2-JNJER-HKK5B  | clip
:xpb
...
:ND
ECHO.
ECHO Failed to detect WIRIS enviroment.
ECHO Generated crash file.
...
:xp
echo 7QG8G-J6Q7Q-PENS2-JNJER-HKK5B  >key.gWiris.txt
